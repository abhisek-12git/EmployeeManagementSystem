...
<%
    ...
    String generatedEmpId = (String) request.getAttribute("generatedEmpId");
    List<Department> departments = (List<Department>) request.getAttribute("departments");
    
    if (generatedEmpId == null) {
        response.sendRedirect("EmpAddServlet");
        return;
    }
...
<div class="container">
    <div class="form-container">
        ...
        <div class="employee-id-display">
            ...
            <span class="employee-id-value" id="displayEmpId"><%= generatedEmpId %></span>
            <input type="hidden" id="emp_id" name="emp_id" value="<%= generatedEmpId %>">
            <div class="form-hint">This ID is auto-generated and will be assigned to the new employee</div>
        </div>
        
        <form action="EmpAddServlet" method="post" id="employeeForm" enctype="multipart/form-data" onsubmit="return validateForm()">
            <input type="hidden" name="emp_id" value="<%= generatedEmpId %>">
            ...
            <div class="form-section">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" id="emp_name" name="emp_name" required placeholder="Enter employee's full name">
                    </div>
                    <div class="form-group">
            ...
            <div class="form-section">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="email" id="emp_email" name="emp_email" required placeholder="employee@company.com">
                    </div>
                    <div class="form-group">
                        <label for="emp_phone" class="required">Phone Number</label>
                        <input type="tel" id="emp_phone" name="emp_phone" required placeholder="+91 1234567890" pattern="[0-9]{10}">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="pin" name="pin" required placeholder="6-digit PIN code" pattern="[0-9]{6}">
                    </div>
                </div>
            </div>
            ...
            <div class="form-section">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="desg" name="desg" required placeholder="Enter designation">
                    </div>
                    <div class="form-group">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <select id="shift_time" name="shift_time">
                            ...
                            <option value="Night Shift">Night Shift (6 PM - 3 AM)</option>
                ...
                <div class="salary-calculator">
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="number" id="basic_salary" name="basic_salary" step="0.01" min="0" required placeholder="0.00" onchange="calculateTotalSalary()">
                        </div>
                        <div class="form-group">
                            <label for="allowances">Allowances</label>
                            <input type="number" id="allowances" name="allowances" step="0.01" min="0" placeholder="0.00" onchange="calculateTotalSalary()">
                        </div>
                        <div class="form-group">
                            <label for="pf">PF Contribution</label>
                            <input type="number" id="pf" name="pf" step="0.01" min="0" placeholder="0.00" onchange="calculateTotalSalary()">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group">
                            <label for="total_salary" class="required">Total Salary</label>
                            <input type="number" id="total_salary" name="total_salary" step="0.01" min="0" required readonly class="auto-generated">
                        </div>
                    </div>
                    <div class="salary-result" id="salaryResult">Total Salary: ₹0.00</div>
                </div>
            </div>
            ...
            <div class="form-section">
                ...
                <div class="form-row">
                    <div class="form-group">
                        <label for="proof_type" class="required">Identity Proof Type</label>
                ...
                <div class="form-group">
                    <label class="required">Upload Identity Proof Document</label>
                    <div class="file-upload-container" id="fileUploadContainer">
                        <div class="file-upload-icon">📁</div>
                        <h4>Upload Identity Proof Document</h4>
                        <p>Supported formats: PDF, JPG, PNG, JPEG, DOC, DOCX</p>
                        <p>Max file size: 5MB</p>
                        <input type="file" id="proof_document" name="proof_document" class="file-input" accept=".pdf,.jpg,.jpeg,.png,.doc,.docx" onchange="handleFileSelect(this)">
                        <button type="button" class="file-upload-btn" onclick="document.getElementById('proof_document').click()">Choose File</button>
                        ...
                        <div class="file-info" id="fileInfo" style="display: none;">
                            ...
                            <div class="file-details">
                                ...
                                <button type="button" class="remove-file-btn" onclick="removeFile()">Remove File</button>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    function validateForm() {
        ...
        if (!proofDocument) {
            alert('Please upload the identity proof document.');
            return false;
        }
...
<head>
<meta charset="UTF-8">
<title>WorkSphere Pro - Add Employee</title>
...
<div class="container">
    <div class="form-container">
        ...
        <div class="employee-id-display">
            <span class="employee-id-label">Employee ID:</span>
            <div class="employee-id-value" id="displayEmpId"><%= generatedEmpId %></div>
            <input type="hidden" id="emp_id" name="emp_id" value="<%= generatedEmpId %>">
            <div class="form-hint">This ID is auto-generated and will be assigned to the new employee</div>
        </div>
...
<script>
    ...
    function validateForm() {
        ...
        if (!proofDocument) {
            showErrorMessage('Please upload the identity proof document.');
            return false;
        }
